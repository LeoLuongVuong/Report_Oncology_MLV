...
;; 2. Description: Erlotinib and Dactolisib with ATUX resetting omega of 005
...
$OMEGA BLOCK(1) 0.00661 ; within-day variability TOP  
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) 0.0213 ; within-day variability BOTTOM
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) 0 FIX ; within-day variability IC50
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) 0 FIX ; within-day variability GAMMA
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
...
ONEHEADER NOPRINT FILE = onco_combine_therapy_out_007.csv
