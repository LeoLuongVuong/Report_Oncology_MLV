...
;; 1. Based on: run_onco_002
;; 2. Description: Erlotinib and Dactolisib with ATUX 003. Change all the parameters that are approximate 0 to 0.
...
$OMEGA	;;; inter-experiment variability
 ...
 0 FIX
 0 FIX ; 
$OMEGA BLOCK(1) 0.0379 ; inter-day variability TOP  = intra-experiment variability
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) 0.116 ; inter-day variability BOTTOM
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) 0.0675 ; inter-day variability IC50
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) 0 FIX ; inter-day variability GAMMA
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
$OMEGA BLOCK(1) SAME
...
ONEHEADER NOPRINT FILE = onco_combine_therapy_out_003.csv
