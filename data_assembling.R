...
dat1 <- onco_combine_therapy_out |>  
  filter(ID == 1) |>  
  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)

model_id1 <- function(x) { dat1$TVBOTTOM + ( (dat1$TVTOP - dat1$TVBOTTOM) / ( 1 + ((x/dat1$TVIC50)^dat1$TVGAMMA) ) )}

dat2 <- onco_combine_therapy_out |>  
  filter(ID == 2) |>  
  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)

model_id2 <- function(x) { dat2$TVBOTTOM + ( (dat2$TVTOP-dat2$TVBOTTOM) / ( 1+ ((x/dat2$TVIC50)^dat2$TVGAMMA) ) )}

dat3 <- onco_combine_therapy_out |>  filter(ID == 3) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
model_id3 <- function(x) { dat3$TVBOTTOM + ( (dat3$TVTOP-dat3$TVBOTTOM) / ( 1+ ((x/dat3$TVIC50)^dat3$TVGAMMA) ) )}
dat4 <- onco_combine_therapy_out |>  filter(ID == 4) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
model_id4 <- function(x) { dat4$TVBOTTOM + ( (dat4$TVTOP-dat4$TVBOTTOM) / ( 1+ ((x/dat4$TVIC50)^dat4$TVGAMMA) ) )}
dat5 <- onco_combine_therapy_out |>  filter(ID == 5) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
model_id5 <- function(x) { dat5$TVBOTTOM + ( (dat5$TVTOP-dat5$TVBOTTOM) / ( 1+ ((x/dat5$TVIC50)^dat5$TVGAMMA) ) )}
dat6 <- onco_combine_therapy_out |>  filter(ID == 6) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
model_id6 <- function(x) { dat6$TVBOTTOM + ( (dat6$TVTOP-dat6$TVBOTTOM) / ( 1+ ((x/dat6$TVIC50)^dat6$TVGAMMA) ) )}
dat7 <- onco_combine_therapy_out |>  filter(ID == 7) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
model_id7 <- function(x) { dat7$TVBOTTOM + ( (dat7$TVTOP-dat7$TVBOTTOM) / ( 1+ ((x/dat7$TVIC50)^dat7$TVGAMMA) ) )}
dat8 <- onco_combine_therapy_out |>  filter(ID == 8) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
model_id8 <- function(x) { dat8$TVBOTTOM + ( (dat8$TVTOP-dat8$TVBOTTOM) / ( 1+ ((x/dat8$TVIC50)^dat8$TVGAMMA) ) )}
dat9 <- onco_combine_therapy_out |>  filter(ID == 9) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
model_id9 <- function(x) { dat9$TVBOTTOM + ( (dat9$TVTOP-dat9$TVBOTTOM) / ( 1+ ((x/dat9$TVIC50)^dat9$TVGAMMA) ) )}

# ID 10-19
dat10 <- onco_combine_therapy_out |>  filter(ID == 10) |>  distinct(ID,CELLINE,ADDITIVECONC,TVTOP,TVBOTTOM,TVIC50,TVGAMMA)
...
upper_DRUGCONC <- onco_combine_therapy_out |>  group_by(ID) |>  slice(n()) |>  ungroup() |>   select(ID, DRUGCONC)
...
onco_combine_therapy_out <- full_join(onco_combine_therapy_out, DSS      |>  select(ID, AUC           ), by = c("ID"))
onco_combine_therapy_out <- full_join(onco_combine_therapy_out, DSS_bttm |>  select(ID, BTTM, BTTM_AUC, upper_DRUGCONC), by = c("ID"))

onco_combine_therapy_out <- onco_combine_therapy_out |>  mutate(DSS0  = (AUC-(TVBOTTOM*upper_DRUGCONC)), # BOTTOM is the model EGFRameter estimate. BTTM = the value of Y where X=45. BTTM_AUC = BTTM*upper_DRUGCONC = the AUC below BTTM from 0 to 45.
...
# onco_combine_therapy_out <- read.table (file='~/Library/CloudStorage/OneDrive-KULeuven/PhD Garin/new Michiel_combinational_therapy_analysis_2023//modeling/run003_out.csv', skip=1, header=T)
# onco_combine_therapy_out$CELLINE <- ordered(onco_combine_therapy_out$CELLINE, levels=c(1, 2, 3, 4, 5),
#                             labels=c("EGFP", "WT", "R183W", "P179R", "S256F"))
# onco_combine_therapy_out <- onco_combine_therapy_out |>  group_by(ID,DAY)   |>  mutate(ID_DAY   = cur_group_id()) |>  ungroup()
# 
# setwd("~/Library/CloudStorage/OneDrive-KULeuven/PhD Garin/new Michiel_combinational_therapy_analysis_2023/plots/")
# 
# #### define the equations for effect curve ####################################
# # 1-10
# dat1 <- onco_combine_therapy_out |>  filter(ID_DAY == 1) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id1 <- function(x) { dat1$BOTTOM + ( (dat1$TOP-dat1$BOTTOM) / ( 1+ ((x/dat1$IC50)^dat1$GAMMA) ) )}
# dat2 <- onco_combine_therapy_out |>  filter(ID_DAY == 2) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id2 <- function(x) { dat2$BOTTOM + ( (dat2$TOP-dat2$BOTTOM) / ( 1+ ((x/dat2$IC50)^dat2$GAMMA) ) )}
# dat3 <- onco_combine_therapy_out |>  filter(ID_DAY == 3) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id3 <- function(x) { dat3$BOTTOM + ( (dat3$TOP-dat3$BOTTOM) / ( 1+ ((x/dat3$IC50)^dat3$GAMMA) ) )}
# dat4 <- onco_combine_therapy_out |>  filter(ID_DAY == 4) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id4 <- function(x) { dat4$BOTTOM + ( (dat4$TOP-dat4$BOTTOM) / ( 1+ ((x/dat4$IC50)^dat4$GAMMA) ) )}
# dat5 <- onco_combine_therapy_out |>  filter(ID_DAY == 5) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id5 <- function(x) { dat5$BOTTOM + ( (dat5$TOP-dat5$BOTTOM) / ( 1+ ((x/dat5$IC50)^dat5$GAMMA) ) )}
# dat6 <- onco_combine_therapy_out |>  filter(ID_DAY == 6) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id6 <- function(x) { dat6$BOTTOM + ( (dat6$TOP-dat6$BOTTOM) / ( 1+ ((x/dat6$IC50)^dat6$GAMMA) ) )}
# dat7 <- onco_combine_therapy_out |>  filter(ID_DAY == 7) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id7 <- function(x) { dat7$BOTTOM + ( (dat7$TOP-dat7$BOTTOM) / ( 1+ ((x/dat7$IC50)^dat7$GAMMA) ) )}
# dat8 <- onco_combine_therapy_out |>  filter(ID_DAY == 8) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id8 <- function(x) { dat8$BOTTOM + ( (dat8$TOP-dat8$BOTTOM) / ( 1+ ((x/dat8$IC50)^dat8$GAMMA) ) )}
# dat9 <- onco_combine_therapy_out |>  filter(ID_DAY == 9) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id9 <- function(x) { dat9$BOTTOM + ( (dat9$TOP-dat9$BOTTOM) / ( 1+ ((x/dat9$IC50)^dat9$GAMMA) ) )}
# 
# # ID_DAY 10-19
# dat10 <- onco_combine_therapy_out |>  filter(ID_DAY == 10) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id10 <- function(x) { dat10$BOTTOM + ( (dat10$TOP-dat10$BOTTOM) / ( 1+ ((x/dat10$IC50)^dat10$GAMMA) ) )}
# dat11 <- onco_combine_therapy_out |>  filter(ID_DAY == 11) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id11 <- function(x) { dat11$BOTTOM + ( (dat11$TOP-dat11$BOTTOM) / ( 1+ ((x/dat11$IC50)^dat11$GAMMA) ) )}
# dat12 <- onco_combine_therapy_out |>  filter(ID_DAY == 12) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id12 <- function(x) { dat12$BOTTOM + ( (dat12$TOP-dat12$BOTTOM) / ( 1+ ((x/dat12$IC50)^dat12$GAMMA) ) )}
# dat13 <- onco_combine_therapy_out |>  filter(ID_DAY == 13) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id13 <- function(x) { dat13$BOTTOM + ( (dat13$TOP-dat13$BOTTOM) / ( 1+ ((x/dat13$IC50)^dat13$GAMMA) ) )}
# dat14 <- onco_combine_therapy_out |>  filter(ID_DAY == 14) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id14 <- function(x) { dat14$BOTTOM + ( (dat14$TOP-dat14$BOTTOM) / ( 1+ ((x/dat14$IC50)^dat14$GAMMA) ) )}
# dat15 <- onco_combine_therapy_out |>  filter(ID_DAY == 15) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id15 <- function(x) { dat15$BOTTOM + ( (dat15$TOP-dat15$BOTTOM) / ( 1+ ((x/dat15$IC50)^dat15$GAMMA) ) )}
# dat16 <- onco_combine_therapy_out |>  filter(ID_DAY == 16) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id16 <- function(x) { dat16$BOTTOM + ( (dat16$TOP-dat16$BOTTOM) / ( 1+ ((x/dat16$IC50)^dat16$GAMMA) ) )}
# dat17 <- onco_combine_therapy_out |>  filter(ID_DAY == 17) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id17 <- function(x) { dat17$BOTTOM + ( (dat17$TOP-dat17$BOTTOM) / ( 1+ ((x/dat17$IC50)^dat17$GAMMA) ) )}
# dat18 <- onco_combine_therapy_out |>  filter(ID_DAY == 18) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id18 <- function(x) { dat18$BOTTOM + ( (dat18$TOP-dat18$BOTTOM) / ( 1+ ((x/dat18$IC50)^dat18$GAMMA) ) )}
# dat19 <- onco_combine_therapy_out |>  filter(ID_DAY == 19) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id19 <- function(x) { dat19$BOTTOM + ( (dat19$TOP-dat19$BOTTOM) / ( 1+ ((x/dat19$IC50)^dat19$GAMMA) ) )}
# 
# # ID_DAY 20-29
# dat20 <- onco_combine_therapy_out |>  filter(ID_DAY == 20) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id20 <- function(x) { dat20$BOTTOM + ( (dat20$TOP-dat20$BOTTOM) / ( 1+ ((x/dat20$IC50)^dat20$GAMMA) ) )}
# dat21 <- onco_combine_therapy_out |>  filter(ID_DAY == 21) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id21 <- function(x) { dat21$BOTTOM + ( (dat21$TOP-dat21$BOTTOM) / ( 1+ ((x/dat21$IC50)^dat21$GAMMA) ) )}
# dat22 <- onco_combine_therapy_out |>  filter(ID_DAY == 22) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id22 <- function(x) { dat22$BOTTOM + ( (dat22$TOP-dat22$BOTTOM) / ( 1+ ((x/dat22$IC50)^dat22$GAMMA) ) )}
# dat23 <- onco_combine_therapy_out |>  filter(ID_DAY == 23) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id23 <- function(x) { dat23$BOTTOM + ( (dat23$TOP-dat23$BOTTOM) / ( 1+ ((x/dat23$IC50)^dat23$GAMMA) ) )}
# dat24 <- onco_combine_therapy_out |>  filter(ID_DAY == 24) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id24 <- function(x) { dat24$BOTTOM + ( (dat24$TOP-dat24$BOTTOM) / ( 1+ ((x/dat24$IC50)^dat24$GAMMA) ) )}
# dat25 <- onco_combine_therapy_out |>  filter(ID_DAY == 25) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id25 <- function(x) { dat25$BOTTOM + ( (dat25$TOP-dat25$BOTTOM) / ( 1+ ((x/dat25$IC50)^dat25$GAMMA) ) )}
# dat26 <- onco_combine_therapy_out |>  filter(ID_DAY == 26) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id26 <- function(x) { dat26$BOTTOM + ( (dat26$TOP-dat26$BOTTOM) / ( 1+ ((x/dat26$IC50)^dat26$GAMMA) ) )}
# dat27 <- onco_combine_therapy_out |>  filter(ID_DAY == 27) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id27 <- function(x) { dat27$BOTTOM + ( (dat27$TOP-dat27$BOTTOM) / ( 1+ ((x/dat27$IC50)^dat27$GAMMA) ) )}
# dat28 <- onco_combine_therapy_out |>  filter(ID_DAY == 28) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id28 <- function(x) { dat28$BOTTOM + ( (dat28$TOP-dat28$BOTTOM) / ( 1+ ((x/dat28$IC50)^dat28$GAMMA) ) )}
# dat29 <- onco_combine_therapy_out |>  filter(ID_DAY == 29) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id29 <- function(x) { dat29$BOTTOM + ( (dat29$TOP-dat29$BOTTOM) / ( 1+ ((x/dat29$IC50)^dat29$GAMMA) ) )}
# 
# # ID_DAY 30-39
# dat30 <- onco_combine_therapy_out |>  filter(ID_DAY == 30) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id30 <- function(x) { dat30$BOTTOM + ( (dat30$TOP-dat30$BOTTOM) / ( 1+ ((x/dat30$IC50)^dat30$GAMMA) ) )}
# dat31 <- onco_combine_therapy_out |>  filter(ID_DAY == 31) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id31 <- function(x) { dat31$BOTTOM + ( (dat31$TOP-dat31$BOTTOM) / ( 1+ ((x/dat31$IC50)^dat31$GAMMA) ) )}
# dat32 <- onco_combine_therapy_out |>  filter(ID_DAY == 32) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id32 <- function(x) { dat32$BOTTOM + ( (dat32$TOP-dat32$BOTTOM) / ( 1+ ((x/dat32$IC50)^dat32$GAMMA) ) )}
# dat33 <- onco_combine_therapy_out |>  filter(ID_DAY == 33) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id33 <- function(x) { dat33$BOTTOM + ( (dat33$TOP-dat33$BOTTOM) / ( 1+ ((x/dat33$IC50)^dat33$GAMMA) ) )}
# dat34 <- onco_combine_therapy_out |>  filter(ID_DAY == 34) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id34 <- function(x) { dat34$BOTTOM + ( (dat34$TOP-dat34$BOTTOM) / ( 1+ ((x/dat34$IC50)^dat34$GAMMA) ) )}
# dat35 <- onco_combine_therapy_out |>  filter(ID_DAY == 35) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id35 <- function(x) { dat35$BOTTOM + ( (dat35$TOP-dat35$BOTTOM) / ( 1+ ((x/dat35$IC50)^dat35$GAMMA) ) )}
# dat36 <- onco_combine_therapy_out |>  filter(ID_DAY == 36) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id36 <- function(x) { dat36$BOTTOM + ( (dat36$TOP-dat36$BOTTOM) / ( 1+ ((x/dat36$IC50)^dat36$GAMMA) ) )}
# dat37 <- onco_combine_therapy_out |>  filter(ID_DAY == 37) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id37 <- function(x) { dat37$BOTTOM + ( (dat37$TOP-dat37$BOTTOM) / ( 1+ ((x/dat37$IC50)^dat37$GAMMA) ) )}
# dat38 <- onco_combine_therapy_out |>  filter(ID_DAY == 38) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id38 <- function(x) { dat38$BOTTOM + ( (dat38$TOP-dat38$BOTTOM) / ( 1+ ((x/dat38$IC50)^dat38$GAMMA) ) )}
# dat39 <- onco_combine_therapy_out |>  filter(ID_DAY == 39) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id39 <- function(x) { dat39$BOTTOM + ( (dat39$TOP-dat39$BOTTOM) / ( 1+ ((x/dat39$IC50)^dat39$GAMMA) ) )}
# 
# # ID_DAY 40-49
# dat40 <- onco_combine_therapy_out |>  filter(ID_DAY == 40) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id40 <- function(x) { dat40$BOTTOM + ( (dat40$TOP-dat40$BOTTOM) / ( 1+ ((x/dat40$IC50)^dat40$GAMMA) ) )}
# dat41 <- onco_combine_therapy_out |>  filter(ID_DAY == 41) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id41 <- function(x) { dat41$BOTTOM + ( (dat41$TOP-dat41$BOTTOM) / ( 1+ ((x/dat41$IC50)^dat41$GAMMA) ) )}
# dat42 <- onco_combine_therapy_out |>  filter(ID_DAY == 42) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id42 <- function(x) { dat42$BOTTOM + ( (dat42$TOP-dat42$BOTTOM) / ( 1+ ((x/dat42$IC50)^dat42$GAMMA) ) )}
# dat43 <- onco_combine_therapy_out |>  filter(ID_DAY == 43) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id43 <- function(x) { dat43$BOTTOM + ( (dat43$TOP-dat43$BOTTOM) / ( 1+ ((x/dat43$IC50)^dat43$GAMMA) ) )}
# dat44 <- onco_combine_therapy_out |>  filter(ID_DAY == 44) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id44 <- function(x) { dat44$BOTTOM + ( (dat44$TOP-dat44$BOTTOM) / ( 1+ ((x/dat44$IC50)^dat44$GAMMA) ) )}
# dat45 <- onco_combine_therapy_out |>  filter(ID_DAY == 45) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id45 <- function(x) { dat45$BOTTOM + ( (dat45$TOP-dat45$BOTTOM) / ( 1+ ((x/dat45$IC50)^dat45$GAMMA) ) )}
# dat46 <- onco_combine_therapy_out |>  filter(ID_DAY == 46) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id46 <- function(x) { dat46$BOTTOM + ( (dat46$TOP-dat46$BOTTOM) / ( 1+ ((x/dat46$IC50)^dat46$GAMMA) ) )}
# dat47 <- onco_combine_therapy_out |>  filter(ID_DAY == 47) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id47 <- function(x) { dat47$BOTTOM + ( (dat47$TOP-dat47$BOTTOM) / ( 1+ ((x/dat47$IC50)^dat47$GAMMA) ) )}
# dat48 <- onco_combine_therapy_out |>  filter(ID_DAY == 48) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id48 <- function(x) { dat48$BOTTOM + ( (dat48$TOP-dat48$BOTTOM) / ( 1+ ((x/dat48$IC50)^dat48$GAMMA) ) )}
# dat49 <- onco_combine_therapy_out |>  filter(ID_DAY == 49) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id49 <- function(x) { dat49$BOTTOM + ( (dat49$TOP-dat49$BOTTOM) / ( 1+ ((x/dat49$IC50)^dat49$GAMMA) ) )}
# 
# # ID_DAY 50-59
# dat50 <- onco_combine_therapy_out |>  filter(ID_DAY == 50) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id50 <- function(x) { dat50$BOTTOM + ( (dat50$TOP-dat50$BOTTOM) / ( 1+ ((x/dat50$IC50)^dat50$GAMMA) ) )}
# dat51 <- onco_combine_therapy_out |>  filter(ID_DAY == 51) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id51 <- function(x) { dat51$BOTTOM + ( (dat51$TOP-dat51$BOTTOM) / ( 1+ ((x/dat51$IC50)^dat51$GAMMA) ) )}
# dat52 <- onco_combine_therapy_out |>  filter(ID_DAY == 52) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id52 <- function(x) { dat52$BOTTOM + ( (dat52$TOP-dat52$BOTTOM) / ( 1+ ((x/dat52$IC50)^dat52$GAMMA) ) )}
# dat53 <- onco_combine_therapy_out |>  filter(ID_DAY == 53) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id53 <- function(x) { dat53$BOTTOM + ( (dat53$TOP-dat53$BOTTOM) / ( 1+ ((x/dat53$IC50)^dat53$GAMMA) ) )}
# dat54 <- onco_combine_therapy_out |>  filter(ID_DAY == 54) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id54 <- function(x) { dat54$BOTTOM + ( (dat54$TOP-dat54$BOTTOM) / ( 1+ ((x/dat54$IC50)^dat54$GAMMA) ) )}
# dat55 <- onco_combine_therapy_out |>  filter(ID_DAY == 55) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id55 <- function(x) { dat55$BOTTOM + ( (dat55$TOP-dat55$BOTTOM) / ( 1+ ((x/dat55$IC50)^dat55$GAMMA) ) )}
# dat56 <- onco_combine_therapy_out |>  filter(ID_DAY == 56) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id56 <- function(x) { dat56$BOTTOM + ( (dat56$TOP-dat56$BOTTOM) / ( 1+ ((x/dat56$IC50)^dat56$GAMMA) ) )}
# dat57 <- onco_combine_therapy_out |>  filter(ID_DAY == 57) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id57 <- function(x) { dat57$BOTTOM + ( (dat57$TOP-dat57$BOTTOM) / ( 1+ ((x/dat57$IC50)^dat57$GAMMA) ) )}
# dat58 <- onco_combine_therapy_out |>  filter(ID_DAY == 58) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id58 <- function(x) { dat58$BOTTOM + ( (dat58$TOP-dat58$BOTTOM) / ( 1+ ((x/dat58$IC50)^dat58$GAMMA) ) )}
# dat59 <- onco_combine_therapy_out |>  filter(ID_DAY == 59) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id59 <- function(x) { dat59$BOTTOM + ( (dat59$TOP-dat59$BOTTOM) / ( 1+ ((x/dat59$IC50)^dat59$GAMMA) ) )}
# 
# # ID_DAY 60-66
# dat60 <- onco_combine_therapy_out |>  filter(ID_DAY == 60) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id60 <- function(x) { dat60$BOTTOM + ( (dat60$TOP-dat60$BOTTOM) / ( 1+ ((x/dat60$IC50)^dat60$GAMMA) ) )}
# dat61 <- onco_combine_therapy_out |>  filter(ID_DAY == 61) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id61 <- function(x) { dat61$BOTTOM + ( (dat61$TOP-dat61$BOTTOM) / ( 1+ ((x/dat61$IC50)^dat61$GAMMA) ) )}
# dat62 <- onco_combine_therapy_out |>  filter(ID_DAY == 62) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id62 <- function(x) { dat62$BOTTOM + ( (dat62$TOP-dat62$BOTTOM) / ( 1+ ((x/dat62$IC50)^dat62$GAMMA) ) )}
# dat63 <- onco_combine_therapy_out |>  filter(ID_DAY == 63) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id63 <- function(x) { dat63$BOTTOM + ( (dat63$TOP-dat63$BOTTOM) / ( 1+ ((x/dat63$IC50)^dat63$GAMMA) ) )}
# dat64 <- onco_combine_therapy_out |>  filter(ID_DAY == 64) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id64 <- function(x) { dat64$BOTTOM + ( (dat64$TOP-dat64$BOTTOM) / ( 1+ ((x/dat64$IC50)^dat64$GAMMA) ) )}
# dat65 <- onco_combine_therapy_out |>  filter(ID_DAY == 65) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
# model_id65 <- function(x) { dat65$BOTTOM + ( (dat65$TOP-dat65$BOTTOM) / ( 1+ ((x/dat65$IC50)^dat65$GAMMA) ) )}
# dat66 <- onco_combine_therapy_out |>  filter(ID_DAY == 66) |>  distinct(ID_DAY,CELLINE,ADDITIVECONC,TOP,BOTTOM,IC50,GAMMA)
...
# 
# # upper concentration varies by drug
# upper_DRUGCONC <- onco_combine_therapy_out |>  group_by(ID_DAY) |>  slice(n()) |>  ungroup() |>   select(ID_DAY, DRUGCONC)
# 
# # calculate effect AUC from 0 to upper drug concentration
# DSS <- 0
# for(i in 1:66){
...
# 
# onco_combine_therapy_out <- full_join(onco_combine_therapy_out, DSS      |>  select(ID_DAY, AUC           ), by = c("ID_DAY"))
# onco_combine_therapy_out <- full_join(onco_combine_therapy_out, DSS_bttm |>  select(ID_DAY, BTTM, BTTM_AUC, upper_DRUGCONC), by = c("ID_DAY"))
# 
# onco_combine_therapy_out <- onco_combine_therapy_out |>  mutate(DSS0  = (AUC-(BOTTOM*upper_DRUGCONC)), # BOTTOM is the model EGFRameter estimate. BTTM = the value of Y where X=45. BTTM_AUC = BTTM*upper_DRUGCONC = the AUC below BTTM from 0 to 45.
#                                 DSS0i = (AUC-(BTTM_AUC   )), # Bottom was not always reached at Sora/Regora = 45 --> therefore this.
...
#                     onco_combine_therapy_out |>  select(ID_DAY, TOP, BOTTOM, IC50, GAMMA, AUC,upper_DRUGCONC, BTTM, BTTM_AUC, DSS0, DSS1, DSS2, DSS3, DSS0i, DSS1i, DSS2i, DSS3i),
#                     by = c("ID_DAY"))
# 
# 
# ################################################################################
